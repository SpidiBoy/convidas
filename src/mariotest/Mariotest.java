...
handler.addObj(plataformaVertical2);
    ...
    private void initialize() {
        ...
        Princesa pric = new Princesa(180, 6, 2, handler);
        handler.addObj(pric);
        
        System.out.println("[INIT] Configurando sistema de fuegos...");
        
LlamaEstatica trampa1 = new LlamaEstatica(122, 342, 2, handler);
handler.addObj(trampa1);
LlamaEstatica trampa2 = new LlamaEstatica(127, 342, 2, handler);
handler.addObj(trampa2);
LlamaEstatica trampa3 = new LlamaEstatica(199, 342, 2, handler);
handler.addObj(trampa3);
LlamaEstatica trampa4 = new LlamaEstatica(349, 342, 2, handler);
...
Martillo martillo = new Martillo(100, 320, 2, handler);
    ...
    private void tick() {
        ...
        // Intentar recuperarse
            if (handler.getPlayer() != null) {
                Player player = handler.getPlayer();
                //System.out.println("[RECUPERACIÓN] Estado player: " + 
                 //                player.getEstadoVida().getClass().getSimpleName());
                //System.out.println("[RECUPERACIÓN] Posición: (" + player.getX() + ", " + player.getY() + ")");
            }
